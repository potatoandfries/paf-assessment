...
public class BookingsRepository {
	...
	public void newUser(User user) {
		template.update(Queries.SQL_INSERT_NEW_USER, user);
	...
	public void newBookings(Bookings bookings) {
		template.update(Queries.SQL_INSERT_BOOKING,bookings.getListingId(),bookings.getEmail(),bookings.getDuration());
	}
}
