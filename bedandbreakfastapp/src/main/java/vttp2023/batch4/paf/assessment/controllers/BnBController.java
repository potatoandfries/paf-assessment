...
public class BnBController {
	...
	public ResponseEntity<String> updateReview(@RequestBody MultiValueMap<String, String> formData){
    try {
        Integer id = Integer.parseInt(formData.getFirst("_id"));
        String name = formData.getFirst("name");
        String email = formData.getFirst("email");
        Integer duration = Integer.parseInt(formData.getFirst("duration"));
